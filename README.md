...
## Dataset
The dataset was collected through a survey related to online fashion purchasing behavior. It includes variables related to marketing factors such as **Product, Price, Place, and Promotion**, as well as consumer purchase decision levels.

## Tools
- Excel (data preparation)
- Python / Google Colab (data analysis)
- Statistical analysis using libraries such as **scikit-learn, pandas, and statsmodels**
